...
df19 = pd.read_csv('/home/11394153/featureskeras/pets_ll.csv',header=None)
df22 = pd.read_csv('/home/11394153/featureskeras/selfie_ll.csv',header=None)
...
np.save('YtestPEOPETSll,npy',Y_test)
...
np.save('YpredPEOPETSll.npy',predictionsHL)
