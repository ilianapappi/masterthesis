...
df19 = pd.read_csv('/home/11394153/featuresvsent/pets_vsent.csv').drop('id_new',1)
df22 = pd.read_csv('/home/11394153/featuresvsent/selfie_vsent.csv').drop('id_new',1)
...
np.save('YpredPEOPETSvs.npy',predictionsHL)
